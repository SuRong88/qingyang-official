	...
	<div class="hotel-detail">
		<div class="breadcrumb">
			<div class="wrapper flex flex-ver">
				...
				<span class="spe">/</span>
				<router-link to="/hotel">精选会务酒店</router-link>
				<span class="spe">/</span>
				<span>珠海哈哈哈酒店</span>
			</div>
		</div>
		...
		<div class="detail-box wrapper flex flex-jcsb flex-start">
			<div id="tab-menu-box" class="l" :class="{ fixed: tabFix }">
				<ul id="tab-menu" class="tab-menu flex">
					<li class="tab-item" :class="{ 'is-actived': currentTab == index }" v-for="(item, index) in tabArray" :key="index" @click="toScroll('box' + index, index)">
						{{ item }}
					</li>
				</ul>
				<div class="main-box">
					...
					<div class="main03" id="box2">
						...
						<ul class="hotel-infos">
							<li style="position: relative;">
								...
								<span @click="introduce.hide = !introduce.hide" class="btn-show" :class="{ 'is-show': !introduce.hide }">
									{{ introduce.hide ? '展开' : '收起' }}
								</span>
							</li>
							<li>
